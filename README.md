...
- Домен «Мониторинга Телеметрии»
- Домен «Управление Пользователями»
- Домен «Хранение Профилей Пользователей»
- Домен «Взаимодействие Пользователей с Системой через Веб-интерфейс»
...
```markdown
[Откройте ссылку](https://drive.google.com/file/d/1xEBaL9Fr4bQNtW0f1y7tQXsmehKvLcQN/view?usp=share_link)
```
...
Добавьте диаграмму.
```markdown
[Откройте ссылку](https://drive.google.com/file/d/1M5YtltGFTiGWony4frzrMePLWklhnaaP/view?usp=share_link)
```
